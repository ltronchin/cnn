...
class My_callbacks():
    ...
    def callbacks_ReduceLROnPlateau(self):
        ...
        # learning rate is reduced by the “factor” specified. Improvement is specified by the “min_delta” argument.
        # No improvement is considered if the change in the monitored quantity is less than the min_delta specified.
        # This also has an option whether you want to start evaluating the new LR instantly or give some
